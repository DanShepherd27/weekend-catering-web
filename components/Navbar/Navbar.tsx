...
const Navbar = () => {
  return (
    <nav className="sticky top-0 z-50 pt-4 md:pt-6 lg:pt-8 pb-2 md:pb-3 lg:pb-4 px-4 flex justify-center">
      <div className="bg-[#ff1100] rounded-[40px] md:rounded-[60px] lg:rounded-[75px] shadow-lg overflow-hidden relative h-[80px] md:h-[60px] lg:h-[60px] max-w-[1500px] w-full">
